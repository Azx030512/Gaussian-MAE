...
class MACGSDataset(data.Dataset):
    def __init__(self, config):
        ...
        print_log(f"[DATASET] Using Guassian Attribute {self.attribute}",logger="MAC Gaussian")
        print_log(f"[DATASET] sample out {self.sample_points_num} points",logger="MAC Gaussian")
        print_log(f"[DATASET] Open file {self.data_list_file}", logger="MAC Gaussian")
